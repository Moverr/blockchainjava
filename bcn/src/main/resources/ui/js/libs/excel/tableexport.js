...
(function (window, undefined) {
    ...
    $.fn.tableExport = function (options, isUpdate) {
        ...
        $this.each(function () {
            ...
            function appendXlsButtonToBottomButtonPlaceHolder(exportButton)
            {
                $("#exportToXlsDiv").empty();
                $("#exportToXlsDiv").html(exportButton);
            }
            
            function appendXlsxButtonToBottomButtonPlaceHolder(exportButton)
            {
                $("#exportToXlsxDiv").empty();
                $("#exportToXlsxDiv").html(exportButton);
            }
            
            function appendTxtButtonToBottomButtonPlaceHolder(exportButton)
            {
                $("#exportToTxtDiv").empty();
                $("#exportToTxtDiv").html(exportButton);
            }
            
            function appendCsvButtonToBottomButtonPlaceHolder(exportButton)
            {
                $("#exportToPdfDiv").empty();
                $("#exportToPdfDiv").html(exportButton);
            }
            ...
            function createObjButton(dataObject, myContent, myClass) {
                ...
                if(myClass === "xlsx")
                {
                    exportButton = "<button data-fileblob='" + dataObject + "' class='btn customCancelButton' style=\"background-color: #404040;\"><i class=\"mdl-color-text--white material-icons\" role=\"presentation\">file_download</i>" + myContent + "</button>";
                    appendXlsxButtonToBottomButtonPlaceHolder(exportButton);
                }
                if(myClass === "xls")
                {
                    exportButton = "<button data-fileblob='" + dataObject + "' class='btn customCancelButton' style=\"background-color: #404040;\"><i class=\"mdl-color-text--white material-icons\" role=\"presentation\">file_download</i>" + myContent + "</button>";
                    appendXlsButtonToBottomButtonPlaceHolder(exportButton);
                }
                if(myClass === "csv")
                {
                    exportButton = "<button data-fileblob='" + dataObject + "' class='btn customCancelButton' style=\"background-color: #404040;\"><i class=\"mdl-color-text--white material-icons\" role=\"presentation\">file_download</i>" + myContent + "</button>";
                    appendCsvButtonToBottomButtonPlaceHolder(exportButton);
                }
                if(myClass === "txt")
                {
                    exportButton = "<button data-fileblob='" + dataObject + "' class='btn customCancelButton' style=\"background-color: #404040;\"><i class=\"mdl-color-text--white material-icons\" role=\"presentation\">file_download</i>" + myContent + "</button>";
                    appendTxtButtonToBottomButtonPlaceHolder(exportButton);
                }                
    ...
    $.fn.tableExport.defaultButton = "customCancelButton";

    $.fn.tableExport.bootstrap = ["btn", "customCancelButton", "btn-toolbar"];
